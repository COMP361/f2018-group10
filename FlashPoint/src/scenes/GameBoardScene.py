...
from src.sprites.hud.InGameStates import InGameStates
...
class GameBoardScene(object):
    ...
    def _init_sprites(self):
        self.active_sprites.add(PlayerState(0, 30, "Nuri", Color.BLUE))
        ...
        # self.active_sprites.add(PlayerState(0, 286, "Alek", Color.ORANGE))
        # self.active_sprites.add(PlayerState(0, 350, "Abhijay", Color.RED))
        self.active_sprites.add(InGameStates(250, 650,7,3,3))
    ...
    def _init_menu_button(self):
        ...
        #btn.change_bg_image("media/menu.png")
