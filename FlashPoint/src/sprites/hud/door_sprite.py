...
class DoorSprite(pygame.sprite.Sprite, DoorObserver):
    ...
    def __init__(self, door_model: DoorModel, orientation: str, tile_sprite: TileSprite, tile_model: TileModel, id: Tuple[int, int, str]):
        ...
        self.button_input = RectButton(self.tile_sprite.rect.x+100, self.tile_sprite.rect.y+100, 100, 25, Color.BLACK, 0, Text(pygame.font.SysFont('Arial', 20), "Interact with Door", Color.ORANGE))
    ...
    def check(self) -> bool:
        ...
        wall_status = self.door_model.door_status
    ...
    def instantiate_event(self):
        ChopEvent(self.player, self.door_model).execute()
