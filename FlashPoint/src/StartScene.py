...
class StartScene(object):
    def __init__(self, screen):
        ...
        self.resolution = (info_object.current_w, info_object.current_h)
    ...
    def _init_text_box(self, x_pos, y_pos,text):
        ...
        user_box = RectLabel(x_pos, y_pos, box_size[0], box_size[1], Color.BLUE, 0,Text(pygame.font.SysFont('Arial', 20), text, (0, 255, 0, 0)))
        self.label_grp.add(user_box)

    def _init_btn(self, x_pos, y_pos, text):
        box_size = (130,48)
        button = RectButton(x_pos, y_pos, box_size[0], box_size[1], Color.BLUE, 0,Text(pygame.font.SysFont('Arial', 20), text, (0, 255, 0, 0)))
